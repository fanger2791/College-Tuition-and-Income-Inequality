...
This paper reproduces several areas of the original paper which is orginaially from the American Economic Association, utilizing the same datasets in the process. These datasets are unfortuntely not publicly accessible, and are hidden behind a sign in wall. 
...
R was the language and environment used for this reproduction, alongside different packages such as ggplot2, readxl, dplyr, tidyr, knitr packages. 
